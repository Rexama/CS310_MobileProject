...
class OwnBlogFeedView extends StatefulWidget {
  @override
  const OwnBlogFeedView({Key? key, required this.analytics, required this.observer, required this.userId}) : super(key: key);
  final String userId;
  final FirebaseAnalytics analytics;
  final FirebaseAnalyticsObserver observer;

  _OwnBlogFeedView createState() => _OwnBlogFeedView();
}

class _OwnBlogFeedView extends State<OwnBlogFeedView> {
  AuthService auth = AuthService();
  DBService db = DBService();
  List<Blog> allBlogs = [];
  late Future _future = db.getBlogsById(widget.userId, allBlogs);
  bool isAnon = false;
  int currentIndex = 0;
